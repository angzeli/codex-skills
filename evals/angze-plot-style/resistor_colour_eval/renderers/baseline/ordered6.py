"""Condition A: the six source series reinterpreted as ordered levels."""
...
def main() -> None:
    ...
    colours = plt.get_cmap("viridis")([0.10, 0.26, 0.42, 0.58, 0.74, 0.90])

    figure, axis = plt.subplots(figsize=(7.2, 4.8))
    for view, colour in zip(views, colours, strict=True):
        axis.plot(
            view.series.x,
            view.series.y,
            color=colour,
    ...
    output = EVAL_ROOT / "outputs" / "A_baseline" / "ordered6_A.png"
